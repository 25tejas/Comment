...
<body>
	<div class="card" style="border:solid; border-radius: 15px; height:90px;">
		<h1 style="text-align: center; margin-top: 10px;">Spring Boot App</h1>
	</div>
	<div class="container">
	  ...
	  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	    <ul class="navbar-nav mr-auto">
	      ...
	      <sec:authorize access="!isAuthenticated()">
		      ...
		      <li class="nav-item">
		        <a class="nav-link text-dark" href="/user/add">Register</a>
		      </li>
	      ...
	      <sec:authorize access="isAuthenticated()">
	      <li class="nav-item">
	        <a class="nav-link text-dark" href="/comment/">Posts</a>
	      </li>	
	      
	      <li class="nav-item">
	        <a class="nav-link text-dark" href="/comment/add">Add Post</a>
	      </li>
